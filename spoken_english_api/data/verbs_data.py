...
raw_verbs = [
    ...
    ("ask", "asked", "asked", "asking", "అడుగు", "❓", "She asked a difficult question.", "ఆమె కఠినమైన ప్రశ్న అడిగింది.", 2),
    ("arrive", "arrived", "arrived", "arriving", "చేరుకో", "🛬", "They arrived late to the party.", "వారు పార్టీలో ఆలస్యంగా వచ్చారు.", 3),
    ("agree", "agreed", "agreed", "agreeing", "ఒప్పుకోవడం", "✅", "We agreed to the plan.", "మేము ఆ ప్రణాళికను ఒప్పుకున్నాము.", 4),
    ("apologize", "apologized", "apologized", "apologizing", "క్షమాపణ చెప్పు", "🙏", "He apologized for his mistake.", "తాను చేసిన తప్పుకు అతను క్షమాపణ కోరాడు.", 5),
